...
for (let i = 0; i < candidateAnswers.length; i++) {
  candidateAnswers[i] = input.question(x + ") " + questions[i]);
  x++;
}
}
  ...
  for (let i = 0; i < candidateAnswers.length; i++){
    ...
    console.log("The correct answer was: " + correctAnswers[i]);
      ...
      if(candidateAnswers[i].toLowerCase() == correctAnswers[i].toLowerCase()) {
        ...
        console.log("Sorry! This response was incorrect!");
      }
  }
...
console.log(numberCorrect + " of " + numberOfQuestions + " your answers were correct");
